...
-- Linhas (6 registros)
INSERT INTO linhas (nome_linhas) VALUES
('ROXA'),
('AZUL'),
('LARANJA'),
('AMARELA');
...
INSERT INTO rotas (id_ponto, id_linha,Linhas) VALUES
(1, 1,'ROXA'),
(1, 2,'AZUL'),
(1, 3,'LARANJA'	),
(1, 4, 'AMARELA');
-- PAROU AQUI E TA ERRADO

-- Horários (6 registros) -> referência a pontos
INSERT INTO horarios (id_pontos, passagem_horarios) VALUES
(1, '06:00:00'),
(1, '07:00:00'),
(2, '06:30:00'),
(3, '08:00:00'),
